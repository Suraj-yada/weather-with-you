...
var firstPerson = 'suraj'; // Replace with the actual name
var firstLocation = 'Varanasi, India'; // Replace with the actual location

var secondPerson = 'anjali'; // Replace with the actual name
var secondLocation = 'Gwalior, India';
...
var timeLeaveStamp = new Date(2024, 9, 28);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2026, 11, 20);
